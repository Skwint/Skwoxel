/**
  ...
  Modified a little bit for Skwoxel by Andy Newman
  Used here as an alternative to godots own noise because this supports 4D queries
*/
#ifndef SKWOXEL_NOISE
#define SKWOXEL_NOISE
