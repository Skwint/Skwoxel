...
namespace skwoxel
{
	...
	real_t SkwoxelFieldScale::strength(const Vector3& pos, const Vector3& untransformed, int thread_num) const
	{
		return SkwoxelFieldAdd::strength(pos / scale, untransformed, thread_num);
	}
}
